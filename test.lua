...
task.spawn(function()
    while task.wait(2) do
        local isCourierTeam = (LP.Team and LP.Team.Name == "Courier")
        if _G.AutofarmCourier and isCourierTeam and _G.CourierEarned >= 79000000 and not isRejoining then
            Rayfield:Notify({
...
HomeTab:CreateButton({
    Name = "Version 1.1 - Teleport Fix",
    Callback = function()
        Rayfield:Notify({
            Title = "Projectsion",
            Content = "+ fixed courier/barista/police teleport rubber-banding\n+ fixed courier sit deadlock\n+ script cleaned",
            Duration = 5
        })
    end
})
